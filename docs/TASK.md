...
- [ ] Define and ingest a clean, comprehensive allowlist of all iPhone product pages on grest.in and use that as the primary test surface for product behavior. (ID: answer-iphone-ingest-surface)
