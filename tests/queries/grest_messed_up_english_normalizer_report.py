...
OUT_MD = ROOT / "tests" / "queries" / "grest_messed_up_english_normalizer_report.md"
...
def run() -> int:
    """Run the messed-up English normalization benchmark and write a Markdown report.
    ...
    # Compose Markdown
    lines: List[str] = []
    lines.append("# GREST Messed-Up English Normalization Report\n")
    ...
    print(f"Wrote messed-up English normalization report to {OUT_MD}")
    return 0
